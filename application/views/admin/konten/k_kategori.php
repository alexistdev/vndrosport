				...
				<div class="col-md-12">
					<div class="card card-dark">
						<div class="card-header">
							...
							<a href="<?= base_url('admin/kategori/add'); ?>"><button class="btn btn-primary btn-sm float-right"><i class="fas fa-plus"></i> &nbsp;Tambah</button></a>
						</div>
						<!-- /.card-header -->
						<div class="card-body">
							<table id="tabelKategori" class="table table-bordered table-hover" style="width: 100%">
								...
								<?php foreach($dataKategori as $row): ?>
									<tr>
										...
										<td ><?= strtoupper(sanitasi($row['nama_kategori'])); ?></td>
										<td class="text-center">
											<a href="<?= base_url('admin/kategori/edit/'.encrypt_url(sanitasi($row['id']))); ?>"><button class="btn btn-sm btn-success" data-toggle="tooltip" data-placement="top" title="Edit"><i class="fas fa-edit"></i></button></a>
