...
<div class="content-wrapper">
	...
	<section class="content-header">
		<div class="container-fluid">
			<div class="row mb-2">
				<div class="col-sm-6">
					<h1>Detail Paket Pengambilan Barang</h1>
				</div>
				<div class="col-sm-6">
						...
						<div class="card-body">
							<table id="tabelRiwayat" class="table table-bordered table-hover" style="width: 100%">
								...
								<?php foreach ($dataToko as $row):?>
									...
									<td><?= sanitasi($row['jumlah']); ?></td>
								<?php endforeach; ?>
								</tbody>
							</table>
							<a href="<?= base_url('admin/transaksi'); ?>"><button class="mt-5 btn btn-sm btn-danger">Kembali</button></a>
						</div>
					</div>
				</div>
			</div>
